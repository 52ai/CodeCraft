    ...
    for (int i=0;i<line_num;i++){
        ...
        switch(space_line_count){
            ...
            case 0 :{
                ...
                if(graph_node_num < 200) {least_consume_bandwidth=65;}
                else if(graph_node_num > 200 && graph_node_num < 500) {least_consume_bandwidth=50;}
                else {least_consume_bandwidth=65;}
                break;
            }
            case 1 :{
                char *substr = strtok(topo[i],seg);
