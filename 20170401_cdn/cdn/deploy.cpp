...
void deploy_server(char * topo[MAX_EDGE_NUM], int line_num, char * filename){
    ...
    **/
    ...
    /*
    mcmf.addedge(7,mcmf.t,INF,0);
    mcmf.addedge(13,mcmf.t,INF,0);
    mcmf.addedge(15,mcmf.t,INF,0);
    mcmf.addedge(22,mcmf.t,INF,0);
    mcmf.addedge(37,mcmf.t,INF,0);
    mcmf.addedge(38,mcmf.t,INF,0);
    mcmf.addedge(43,mcmf.t,INF,0);*/
	
    mcmf.count_out_degree();//计算各个网络节点的出度，并选出候选节点
    mcmf.create_server_edges();//根据服务器部署方案添加边，建图
