...
void deploy_server(char * topo[MAX_EDGE_NUM], int line_num, char * filename){
    ...
    for (int i=0;i<line_num;i++){
        ...
        switch(space_line_count){
            ...
            case 3 :{
                ...
                if(demand_bandwidth > 20){//如果当前消费节点需求大于100，则选择直连.（大于20相对较好）
    ...
    **/
    ...
    //根据图的规模设置粒子群小法惯性系数w
    if(graph_node_num < 200) {w=0.7;r1=1;r2=2;}
    else if(graph_node_num > 200 && graph_node_num < 500) {w=0.5;r1=1;r2=2;}
    else {w=0.2;r1=1;r2=2;}
    ...
    ****/
    ...
    while(((finish_time - start_time)/CLOCKS_PER_SEC < 70) && optimal_repeat_cnt < 50){//每一次循环进行一次粒子的更新并计算适应度
